...
const Navbar = () => {
    ...
    return (
        ...
        <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScrolling ? "bg-white bg-opacity-50 backdrop-blur-lg shadow-sm" : ""}`}>
            <a href="">
                <Image src = {assets.logo} className="w-20 cursor-pointer mr-14" alt = "logo"/>
            </a>
